import { AbstractGameObject } from "./game-objects/abstract-game-object";
import { AbstractGameObjectProvider } from "./game-objects/abstract-game-object-providers";
...
export class Board {
  ...
  private getNewExpirationTimer(bot: object) {
