...
public interface IGameObjectGenerator {//<T> where T : BaseGameObject {
     List<BaseGameObject> RegenerateObjects(Board board);
     List<Position> GetObjectPositions(Board board);
     List<BaseGameObject> GetGameObjectList(Board board);
     /**
